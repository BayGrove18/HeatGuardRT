...
// Assertions force the application into the same safe-output state as a
// runtime fault.  Logging can be added later without allowing execution to
// continue after a failed kernel invariant.
...
#define configUSE_TICKLESS_IDLE					1                       //RTC Alarm 驱动的 STOP tickless idle
